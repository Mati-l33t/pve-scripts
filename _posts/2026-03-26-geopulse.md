...
tags: [geopulse, lxc, monitoring-analytics, auto-update, dev]
...
<div class="info-callout">
  ...
  <div>To create an admin account: <code>echo 'GEOPULSE_ADMIN_EMAIL=you@example.com' >> /etc/geopulse/geopulse.env && systemctl restart geopulse-backend</code> — then register with that email in the UI.</div>
</div>
