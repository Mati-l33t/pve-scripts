...
tags: [umbrel-os-vm, vm, operating-systems, updateable]
...
icon: "https://cdn.jsdelivr.net/gh/selfhst/icons@main/webp/umbrelos.webp"
#image:
...
<div class="info-callout">
  ...
  <div>This VM use as base a Debian 12 OS with a custom kernel and some additional packages to run Umbrel OS. It is not a standard Debian VM, but it is optimized for Umbrel OS.</div>
</div>
