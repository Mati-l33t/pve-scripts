...
<div class="info-callout">
  ...
  <div>Set a password after installation for postgres user by running <code>echo "ALTER USER postgres with encrypted password 'your_password';" | sudo -u postgres psql</code></div>
</div>

<div class="info-callout">
  <i class="fas fa-info-circle"></i>
  <div>Debian script offers versions <code>15, 16, 17, 18</code>, while Alpine script offers versions <code>15, 16, 17</code>.</div>
</div>
