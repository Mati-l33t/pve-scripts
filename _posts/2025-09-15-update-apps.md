...
tags: [update-apps, pve, proxmox-virtualization, updateable, dev]
...
**Default install:**
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/community-scripts/ProxmoxVED/main/tools/pve/update-apps.sh)"
```
