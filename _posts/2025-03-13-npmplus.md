...
tags: [npmplus, ct, webservers-proxies, auto-update]
...
```
**CPU:** 1 core(s) &nbsp;|&nbsp; **RAM:** 512 MB &nbsp;|&nbsp; **Disk:** 3 GB &nbsp;|&nbsp; **OS:** Alpine 3.23

## Default Credentials

| Username | Password |
|----------|----------|
| \`admin@local.com\` | \`helper-scripts.com\` |
...
> **INFO:** This uses Docker under the hood, as this can not easily be installed bare-metal. 

> **INFO:** The initial starting process can take 1-2min. 
