...
<div class="info-callout">
  ...
  <div>Set a root password if using autologin. This will be the Cockpit password. To set root password run <code>sudo passwd root</code></div>
</div>

<div class="warn-callout">
  <i class="fas fa-exclamation-triangle"></i>
  <div>If you plan on using 45Drives extension with NFS, you must setup LXC as privileged. Some features of 45Drives don't work on Debian 13, so Debian 12 must be used.</div>
</div>
