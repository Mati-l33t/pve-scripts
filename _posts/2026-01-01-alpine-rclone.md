...
tags: [alpine-rclone, lxc, auto-update]
#description: ""  # Add manually
icon: "https://cdn.jsdelivr.net/gh/selfhst/icons@main/webp/alpine-rclone.webp"
#image:
#  path: /assets/img/alpine-rclone.png
#  alt: Alpine-rclone
...
- [Official Website](https://github.com/rclone/rclone)
