...
icon: "https://cdn.jsdelivr.net/gh/selfhst/icons@main/webp/plant-it.webp"
#image:
...
<div class="info-callout">
  ...
  <div>This Script use Adoptium JDK 21 - Sometimes the installation of these takes a while</div>
</div>

<div class="info-callout">
  <i class="fas fa-info-circle"></i>
  <div>After the initial start, the backend requires approx. 1-2 minutes boot time</div>
</div>
