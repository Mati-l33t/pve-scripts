...
tags: [hev-socks5-server, lxc, network-firewall, updateable]
description: "HevSocks5Server is a simple, lightweight socks5 server."
icon: "https://cdn.jsdelivr.net/gh/selfhst/icons@main/webp/hev.webp"
#image:
...
**Default install:**
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/ct/hev-socks5-server.sh)"
```
...
<div class="info-callout">
  ...
  <div>Default credentials: <code>cat /root/hev.creds</code></div>
</div>
