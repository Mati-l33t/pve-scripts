...
**Default install:**
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/ct/writefreely.sh)"
```
...
<div class="info-callout">
  ...
  <div>After installation execute <code>writefreely user create --admin <username>:<password></code> to create your user.</div>
</div>
