...
tags: [alpine-wakapi, lxc, monitoring-analytics, updateable]
...
**Default install:**
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/ct/alpine-wakapi.sh)"
```
