...
tags: [add-tailscale-lxc, addon, proxmox-virtualization, updateable]
...
<div class="info-callout">
  ...
  <div>After the script finishes, reboot the LXC then run <code>tailscale up</code> in the LXC console</div>
</div>

<div class="info-callout">
  <i class="fas fa-info-circle"></i>
  <div>Execute within the Proxmox host shell</div>
</div>
