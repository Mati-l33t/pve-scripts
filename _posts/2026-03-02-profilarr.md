...
**Default install:**
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/ct/profilarr.sh)"
```
...
<div class="resource-bar"><span class="res-pill res-port">Port: 6868</span></div>

## Links

- [Official Website](https://github.com/Dictionarry-Hub/profilarr)
