...
tags: [openwrt-vm, vm, network-firewall, operating-systems, updateable]
...
<div class="info-callout">
  ...
  <div>If you use VLANs (default LAN is set to VLAN 999), make sure the Proxmox Linux Bridge is configured as VLAN-aware, otherwise the VM may fail to start.</div>
</div>
