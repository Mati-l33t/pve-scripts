...
<div class="info-callout">
  <i class="fas fa-info-circle"></i>
  <div>Non-Debian/Ubuntu containers will be skipped automatically.</div>
</div>

<div class="warn-callout">
  <i class="fas fa-exclamation-triangle"></i>
  <div>Stopped containers will be started temporarily to run the command, then shut down again.</div>
</div>
