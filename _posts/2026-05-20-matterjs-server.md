...
tags: [matterjs-server, lxc, iot-smart-home, updateable, dev]
...
**Default install:**
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/community-scripts/ProxmoxVED/main/ct/matterjs-server.sh)"
```
