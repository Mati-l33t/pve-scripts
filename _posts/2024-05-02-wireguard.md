...
tags: [wireguard, lxc, network-firewall, updateable]
...
icon: "https://cdn.jsdelivr.net/gh/selfhst/icons@main/webp/wireguard.webp"
#image:
...
<div class="info-callout">
  ...
  <div>Wireguard and WGDashboard are not the same. More info: <code>https://wgdashboard.dev/</code></div>
</div>

<div class="info-callout">
  <i class="fas fa-info-circle"></i>
  <div>WGDashboard installation is optional.</div>
</div>
