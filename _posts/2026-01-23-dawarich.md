...
**Default install:**
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/ct/dawarich.sh)"
```
...
<div class="warn-callout">
  ...
  <div>Default credentials: demo@dawarich.app / password - Change after first login!</div>
</div>
