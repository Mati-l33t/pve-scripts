...
tags: [jellyseerr, lxc, auto-update]
#description: ""  # Add manually
icon: "https://cdn.jsdelivr.net/gh/selfhst/icons@main/webp/jellyseerr.webp"
#image:
#  path: /assets/img/jellyseerr.png
#  alt: Jellyseerr
...
- [Official Website](https://docs.jellyseerr.dev/)
