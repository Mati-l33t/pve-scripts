...
tags: [podman-homeassistant, lxc, iot-smart-home, updateable]
...
**Default install:**
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/ct/podman-homeassistant.sh)"
```
...
<div class="info-callout">
  ...
  <div>config path: <code>/var/lib/containers/storage/volumes/hass_config/_data</code></div>
</div>

<div class="warn-callout">
  <i class="fas fa-exclamation-triangle"></i>
  <div>Options to Install Portainer or Portainer Agent</div>
</div>
