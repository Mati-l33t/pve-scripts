...
**Default install:**
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/ct/manyfold.sh)"
```
...
<div class="info-callout">
  ...
  <div>Setup library on first connection in /opt/manyfold/data</div>
</div>
