...
tags: [alpine-tinyauth, lxc, auto-update]
#description: ""  # Add manually
icon: "https://cdn.jsdelivr.net/gh/selfhst/icons@main/webp/alpine-tinyauth.webp"
#image:
#  path: /assets/img/alpine-tinyauth.png
#  alt: Alpine-Tinyauth
...
- [Official Website](https://github.com/steveiliop56/tinyauth)
