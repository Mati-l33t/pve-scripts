...
<div class="info-callout">
  ...
  <div>Application credentials: <code>cat /etc/zitadel/INSTALLATION_INFO.txt</code></div>
</div>

<div class="info-callout">
  <i class="fas fa-info-circle"></i>
  <div>Change the ExternalDomain value in <code>/etc/zitadel/config.yaml</code> to your domain/hostname/IP and run <code>bash zitadel-rerun.sh</code></div>
</div>
