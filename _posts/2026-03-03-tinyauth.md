...
**Default install:**
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/ct/tinyauth.sh)"
```
...
<div class="info-callout">
  ...
  <div>The default credentials are located in <code>/opt/tinyauth/credentials.txt</code>.</div>
</div>
