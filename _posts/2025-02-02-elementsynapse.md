...
tags: [elementsynapse, lxc, network-firewall, updateable]
...
icon: "https://cdn.jsdelivr.net/gh/selfhst/icons@main/webp/element.webp"
#image:
...
<div class="info-callout">
  ...
  <div>Type <code>cat ~/matrix.creds</code> to see admin username/password.</div>
</div>

<div class="info-callout">
  <i class="fas fa-info-circle"></i>
  <div>Synapse-Admin is running on port 5173</div>
</div>

<div class="info-callout">
  <i class="fas fa-info-circle"></i>
  <div>For bridges Installation methods (WhatsApp, Signal, Discord, etc.), see: ´https://docs.mau.fi/bridges/go/setup.html´</div>
</div>
