...
icon: "https://cdn.jsdelivr.net/gh/selfhst/icons@main/webp/cosmos-server.webp"
#image:
...
<div class="info-callout">
  ...
  <div>The file <code>/etc/sysconfig/CosmosCloud</code> is optional. If you need custom settings, you can create it yourself.</div>
</div>

<div class="warn-callout">
  <i class="fas fa-exclamation-triangle"></i>
  <div>Requires FUSE support for mergerfs functionality. FUSE is enabled by default during installation.</div>
</div>
