...
#image:
#  path: /assets/img/unifi-os-server-vm.png
#  alt: Unifi OS Server VM
---
...
**Default install:**
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/community-scripts/ProxmoxVED/main/vm/unifi-os-server-vm.sh)"
```
