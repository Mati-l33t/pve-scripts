...
tags: [openziti-tunnel, lxc, network-firewall, updateable]
...
**Default install:**
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/ct/openziti-tunnel.sh)"
```
