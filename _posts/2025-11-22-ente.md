...
<div class="warn-callout">
  ...
  <div>First-Start: Run <code>ente-setup</code> — it guides you through account creation, verification, and admin configuration</div>
</div>

<div class="info-callout">
  <i class="fas fa-info-circle"></i>
  <div>For CLI admin docs see https://ente.io/help/self-hosting/administration/cli</div>
</div>

<div class="info-callout">
  <i class="fas fa-info-circle"></i>
  <div>Museum config: <code>cat /opt/ente/server/museum.yaml</code></div>
</div>
