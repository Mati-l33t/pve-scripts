...
<div class="info-callout">
  <i class="fas fa-info-circle"></i>
  <div>To upgrade subscription later: <code>ente-upgrade-subscription user@example.com</code></div>
</div>

<div class="info-callout">
  <i class="fas fa-info-circle"></i>
  <div>To see Museum config: <code>cat /opt/ente/server/museum.yaml</code></div>
</div>
