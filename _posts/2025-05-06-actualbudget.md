...
tags: [actualbudget, lxc, finance-budgeting, updateable]
...
icon: "https://cdn.jsdelivr.net/gh/selfhst/icons@main/webp/actual-budget.webp"
#image:
...
Config file:
```
/opt/actualbudget-data/config.json
```
