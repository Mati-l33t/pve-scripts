...
tags: [limesurvey, lxc, business-erp, updateable]
...
**Default install:**
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/ct/limesurvey.sh)"
```
...
<div class="info-callout">
  ...
  <div>You will need to input database credentials into LimeSurvey installer. Use <code>cat ~/limesurvey.creds</code> inside LXC.</div>
</div>
