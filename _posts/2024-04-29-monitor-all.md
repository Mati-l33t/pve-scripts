...
<div class="warn-callout">
  ...
  <div>Virtual machines without the QEMU guest agent installed must be excluded.</div>
</div>

<div class="warn-callout">
  <i class="fas fa-exclamation-triangle"></i>
  <div>Prior to generating any new CT/VM not found in this repository, it's necessary to halt Proxmox VE Monitor-All by running <code>systemctl stop ping-instances</code>.</div>
</div>

<div class="info-callout">
  <i class="fas fa-info-circle"></i>
  <div>To make setup changes, first stop the service: <code>systemctl stop ping-instances</code></div>
</div>

<div class="info-callout">
  <i class="fas fa-info-circle"></i>
  <div>To edit pause time: <code>nano /usr/local/bin/ping-instances.sh</code></div>
</div>

<div class="info-callout">
  <i class="fas fa-info-circle"></i>
  <div>To add excluded instances: <code>nano /etc/systemd/system/ping-instances.service</code></div>
</div>

<div class="info-callout">
  <i class="fas fa-info-circle"></i>
  <div>After changes have been saved, <code>systemctl daemon-reload</code> and start the service: <code>systemctl start ping-instances</code></div>
</div>

<div class="info-callout">
  <i class="fas fa-info-circle"></i>
  <div>Monitor-All logs: <code>cat /var/log/ping-instances.log</code></div>
</div>
