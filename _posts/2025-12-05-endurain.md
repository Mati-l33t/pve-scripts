...
icon: "https://cdn.jsdelivr.net/gh/selfhst/icons@main/webp/endurain.webp"
image:
...
**Default install:**
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/ct/endurain.sh)"
```
...
<div class="info-callout">
  ...
  <div>When using a reverse proxy, edit <code>/opt/endurain/frontend/app/dist/env.js</code>.</div>
</div>
