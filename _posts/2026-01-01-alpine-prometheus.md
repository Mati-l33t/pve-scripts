...
tags: [alpine-prometheus, lxc, auto-update]
#description: ""  # Add manually
icon: "https://cdn.jsdelivr.net/gh/selfhst/icons@main/webp/alpine-prometheus.webp"
#image:
#  path: /assets/img/alpine-prometheus.png
#  alt: Alpine-Prometheus
